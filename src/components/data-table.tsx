...
export function DataTable<TData, TValue>({
  ...
  return (
    ...
    >
        ...
        <div className="flex flex-wrap items-end justify-between gap-y-4">
          <div className="flex flex-wrap items-end gap-2">
            ...
            <Button
              variant="ghost"
              onClick={clear}
              className="text-xs text-red-500 bg-white border"
            >
      ...
      {!atEnd && (
        <div className="absolute top-0 right-0 w-12 h-full pointer-events-none bg-gradient-to-l from-red-500/60 to-transparent" />
      )}
