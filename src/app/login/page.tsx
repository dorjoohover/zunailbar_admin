...
const Page = async () => {
  return (
    <section className="fixed top-0 left-0 h-screen w-screen flex-center bg-cover bg-no-repeat p-4 bg-white ">
      ...
      <div className="max-w-7xl bg-white border backdrop-blur-md p-4 rounded-3xl space-y-10 w-full shadow-light">
        <div className="grid lg:grid-cols-3 w-full h-[80vh]">
          <div className="bg-[#1b1328] rounded-2xl col-span-2 hidden lg:block">
            <Image src={"/logo/zu-white.png"} width={300} height={300} alt="logo" />
          </div>
          <div className="lg:p-10 space-y-10 flex-col flex justify-center">
